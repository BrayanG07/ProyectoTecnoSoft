...
public class FrmVenta extends javax.swing.JInternalFrame {
    ...
    //GENERANDO NUMERO DE SERIE AUTOMATICAMENTE
    ...
    private void initComponents() {
        ...
        cboNumPagina.setPreferredSize(new java.awt.Dimension(28, 30));
        ...
        cboTotalPorPagina.setPreferredSize(new java.awt.Dimension(28, 30));
        ...
        btnDesactivar.setPreferredSize(new java.awt.Dimension(60, 40));
        ...
        btnVerVenta.setBackground(new java.awt.Color(102, 102, 102));
        btnVerVenta.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        btnVerVenta.setForeground(new java.awt.Color(255, 255, 255));
        btnVerVenta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/presentacion/imagenes/Ver Ingreso.png"))); // NOI18N
        btnVerVenta.setText("Ver Venta");
        btnVerVenta.setPreferredSize(new java.awt.Dimension(60, 40));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cboNumPagina, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(28, 28, 28)
                .addComponent(jLabel11)
                .addGap(26, 26, 26)
                .addComponent(cboTotalPorPagina, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnVerVenta, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        txtIdCliente.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        txtIdCliente.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 204), 2));
        txtIdCliente.setPreferredSize(new java.awt.Dimension(4, 25));
        ...
        txtNombreCliente.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 204), 2));
        txtNombreCliente.setPreferredSize(new java.awt.Dimension(4, 25));
        ...
        btnSeleccionarCliente.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnSeleccionarCliente.setText("...");
        btnSeleccionarCliente.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 204), 2));
        btnSeleccionarCliente.setPreferredSize(new java.awt.Dimension(4, 25));
        ...
        btnVerArticulos.setPreferredSize(new java.awt.Dimension(4, 25));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnSeleccionarCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(33, 33, 33)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnVerArticulos, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel3)
    ...
    private void btnDesactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDesactivarActionPerformed
        ...
        if (tablaListado.getSelectedRowCount() == 1) {
            ...
            if (JOptionPane.showConfirmDialog(this, "¿Deseas anular la venta: " + comprobante + " " + serie + "-" + numero + " ?", "TecnoSoft", JOptionPane.YES_NO_OPTION) == 0) {
                String resp = this.CONTROL.anular(Integer.parseInt(id));
                if (resp.equals("OK")) {
                    this.mensajeOk("Venta anulada");
                    this.listar("", false);
                } else {
                    this.mensajeError(resp);
                }
            ...
            this.mensajeError("Seleccione 1 venta para anular.");
        }
    ...
    private void btnReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteActionPerformed
        ...
        if (estado.equals("Anulado")) {
            this.mensajeError("La venta esta anulada no se puede generar factura");
            return;
        }
        if (tablaListado.getSelectedRowCount() == 1) {
            String id = String.valueOf(tablaListado.getValueAt(tablaListado.getSelectedRow(), 0));
