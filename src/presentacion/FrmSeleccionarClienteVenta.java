...
public class FrmSeleccionarClienteVenta extends javax.swing.JDialog {
    ...
    /**
     * Creates new form FrmSeleccionarClienteVenta
     */
    public FrmSeleccionarClienteVenta(java.awt.Frame parent, FrmVenta frm, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Seleccione un cliente ");
        ...
        btnSeleccionarProveedor.setBackground(new java.awt.Color(102, 102, 102));
        btnSeleccionarProveedor.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        btnSeleccionarProveedor.setForeground(new java.awt.Color(255, 255, 255));
        btnSeleccionarProveedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/presentacion/imagenes/Seleccionar.png"))); // NOI18N
        btnSeleccionarProveedor.setText("Seleccionar");
        btnSeleccionarProveedor.setPreferredSize(new java.awt.Dimension(60, 37));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(btnSeleccionarProveedor, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(21, 21, 21)
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addComponent(jLabel14, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1065, Short.MAX_VALUE)
        );
    ...
    private void btnActivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActivarActionPerformed
        ...
        if (tablaListado.getSelectedRowCount() == 1) {
            ...
            if (JOptionPane.showConfirmDialog(this, "¿Deseas activar el registro: " + nombre + " ?", "TecnoSoft", JOptionPane.YES_NO_OPTION) == 0) {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (txtEmail.getText().length() > 50) {
            JOptionPane.showMessageDialog(this, "Debes ingresar un email y no debe ser mayor a 50 caracteres.", "TecnoSoft", JOptionPane.WARNING_MESSAGE);
